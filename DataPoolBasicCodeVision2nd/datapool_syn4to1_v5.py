...
from datapool_synthesis_auxiliary import (correct_distortion_patch1, correct_distortion_patch2, 
...
def four_to_one_less_config1_synthetise(img1, img2, img3, img4, lab1_whole, lab2_whole, lab3_whole, lab4_whole, 
    ...
    if lab1_whole[0] == lab1_multi[0] and lab1_whole[1] == lab1_multi[1] and lab1_whole[2] == lab1_multi[2] and lab1_whole[3] == lab1_multi[3]:
        img1, lab1_whole, lab1_multi = shrink_object(img1, lab1_whole, lab1_multi, domain_list = None)
    else: # 多目标列表分析目标群模式, 然后再根据模式选择方案进行缩放处理
        img1, lab1_whole, lab1_multi = shrink_object(img1, lab1_whole, lab1_multi, domain_obj = analyze_pattern(lab1_multi))
    ...
    if lab2_whole[0] == lab2_multi[0] and lab2_whole[1] == lab2_multi[1] and lab2_whole[2] == lab2_multi[2] and lab2_whole[3] == lab2_multi[3]:
        img2, lab2_whole, lab2_multi = shrink_object(img2, lab2_whole, lab2_multi, domain_list = None)
    else: # 多目标列表分析目标群模式, 然后再根据模式选择方案进行缩放处理
        img2, lab2_whole, lab2_multi = shrink_object(img2, lab2_whole, lab2_multi, domain_obj = analyze_pattern(lab2_multi))
    ...
    if lab3_whole[0] == lab3_multi[0] and lab3_whole[1] == lab3_multi[1] and lab3_whole[2] == lab3_multi[2] and lab3_whole[3] == lab3_multi[3]:
        img3, lab3_whole, lab3_multi = shrink_object(img3, lab3_whole, lab3_multi, domain_list = None)
    else: # 多目标列表分析目标群模式, 然后再根据模式选择方案进行缩放处理
        img3, lab3_whole, lab3_multi = shrink_object(img3, lab3_whole, lab3_multi, domain_obj = analyze_pattern(lab3_multi))
    ...
    if lab4_whole[0] == lab4_multi[0] and lab4_whole[1] == lab4_multi[1] and lab4_whole[2] == lab4_multi[2] and lab4_whole[3] == lab4_multi[3]:
        img4, lab1_whole, lab4_multi = shrink_object(img4, lab4_whole, lab4_multi, domain_list = None)
    else: # 多目标列表分析目标群模式, 然后再根据模式选择方案进行缩放处理
        img4, lab1_whole, lab4_multi = shrink_object(img4, lab4_whole, lab4_multi, domain_obj = analyze_pattern(lab4_multi))
