...
class VOCDetection(Dataset):
    ...
    def _do_python_eval(self, output_dir="output", iou=0.5):
        ...
        for i in range(len(areaNam)):
            ...
            rec, prec, ap = voc_eval(filename, annopath, imagesetfile, areaNam[i], cachedir, ovthresh=iou, use_07_metric=use_07_metric)
            aps += [ap]
            if iou == 0.5:
...
class Exp():
    def __init__(self):
        ...
        self.testdata = "/mnt/yoloxredstorig/datasets/"
...
def make_parser():
    ...
    parser.add_argument("-c", "--ckpt", default="/mnt/yoloxredstoridp/YoloXReSA44to1ML93.0+1.47OriDP/77.81_200epoch_16bs_250epoch/best_ckpt.pth", type=str)
