...
def correct_distortion_patch1(width, height, img, lab, count): # ): # 
    # print("+++++++++++")
    # print("count: ", count)
...
def correct_distortion_patch2(width, height, img, lab, count): # ): # 
    # print("+++++++++++")
    # print("count: ", count)
    # print("img.shape: ", img.shape, " ", width, " ", height)
...
def correct_distortion_patch3(width, height, img, lab, count): # ): # 
    # print("+++++++++++")
    # print("count: ", count)
    # print("img.shape: ", img.shape, " ", width, " ", height)
...
def correct_distortion_patch4(width, height, img, lab, count): # ): # 
    # print("+++++++++++")
    # print("count: ", count)
    # print("img.shape: ", img.shape, " ", width, " ", height)
...
def four_to_one_less_config1_synthetise(img1, img2, img3, img4, lab1, lab2, lab3, lab4, 
    ...
    if (new_w * ratio_width_top / img1.shape[1]) == 1 and (new_h * ratio_height / img1.shape[0]) == 1:
        ...
        img1, lab1 = correct_distortion_patch1(new_w * ratio_width_top, new_h * ratio_height, img1, lab1, count) # ) # 
    ...
    if (new_w * (1-ratio_width_top) / img2.shape[1]) == 1 and (new_h * ratio_height / img2.shape[0]) == 1:
        ...
        img2, lab2 = correct_distortion_patch2(new_w * (1-ratio_width_top), new_h * ratio_height, img2, lab2, count) # ) # 
    ...
    if (new_w * ratio_width_bot / img3.shape[1]) == 1 and (new_h * (1-ratio_height) / img3.shape[0]) == 1:
        ...
        img3, lab3 = correct_distortion_patch3(new_w * ratio_width_bot, new_h * (1-ratio_height), img3, lab3, count) # ) # 
    ...
    if (new_w * (1-ratio_width_bot) / img4.shape[1]) == 1 and (new_h * (1-ratio_height) / img4.shape[0]) == 1:
        ...
        img4, lab4 = correct_distortion_patch4(new_w * (1-ratio_width_bot), new_h * (1-ratio_height), img4, lab4, count) # ) # 
